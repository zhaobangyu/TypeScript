...
//es6写法
//1-2-1
function fun1_2_1(val1, val2) {
    return ['fun1_2_1', val1, val2].join('_');
}
//1-2-2
//匿名函数
var fun1_2_2 = function fun1_2_2(val1, val2) {
