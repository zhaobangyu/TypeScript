...
// 08-null和undefined
{
    ...
    // 注：一个变量可以设置多个类型
    {
        var variable_08_3: number | undefined | null;
        //赋值(只能等于null)
        variable_08_3 = 123;
        //输出值到控制台
